...
//                    }
                    ...
                    bucket.create("avatar_url/$folderName/cleopatrasfallingtreasures.info.png", imageBytes, "image/png")
//                            val urlPath = FirebaseStorageUrl.basePath reference "avatar_url" reference "images" getDownloadUrl fileName

                    call.respondText("avatar_url/$folderName/cleopatrasfallingtreasures.info.png")
                } catch (e: Exception) {
                    e.printStackTrace()
                    call.respond(HttpStatusCode.BadRequest, "Error while uploading image")
                }
                ...
                call.respondText("avatar_url/$folderName/cleopatrasfallingtreasures.info.pngsf")
